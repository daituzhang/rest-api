...
let RequirementController = class RequirementController {
    async create({ currentUser: user }, _a) {
        ...
        requirement = await new SuppliesRequirement().setACL(acl).save(Object.assign(Object.assign({}, rest), { hospital, coords: new leanengine_1.GeoPoint(coords), creator: user }), { user });
        return requirement.toJSON();
    }
    getList(province, city, district, hospital, size, index) {
    ...
    async edit({ currentUser: user }, id, _a) {
        ...
        await requirement.save(Object.assign(Object.assign({}, rest), { coords: new leanengine_1.GeoPoint(coords) }), { user });
...
__decorate([
    ...
    __param(0, routing_controllers_1.QueryParam('province')),
    __param(1, routing_controllers_1.QueryParam('city')),
    __param(2, routing_controllers_1.QueryParam('district')),
    __param(3, routing_controllers_1.QueryParam('hospital')),
    __param(4, routing_controllers_1.QueryParam('pageSize')),
    __param(5, routing_controllers_1.QueryParam('pageIndex')),
    __metadata("design:type", Function),
