...
const Logistics_1 = require("../model/Logistics");
...
let LogisticsController = class LogisticsController {
    async create({ currentUser: user }, _a) {
        ...
        logistics = await new Logistics()
            .setACL(acl)
            .save(Object.assign(Object.assign({}, rest), { name, creator: user }), { user });
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Logistics_1.LogisticsModel]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, Logistics_1.LogisticsModel]),
    __metadata("design:returntype", Promise)
